...
export const UserComponent: React.FC<UserComponentProps> = ({ userName, onLogout }) => {
  ...
  const handleLogout = () => {
    ...
    // Вызываем переданную функцию onLogout для дополнительной логики (например, перенаправление)
    onLogout();
